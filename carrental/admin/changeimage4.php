                    ...
                    <div class="card-body p-5">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Current Image4</label>
                                <?php
                                $id = intval($_GET['imgid']);
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {    ?>
                                        ...
                                        <div class="col-sm-8">
                                            <img src="./assets/img/vehicleimages/<?php echo htmlentities($result->Vimage4); ?>" width="300" height="200" style="border:solid 1px #000">
                                        </div>
                                <?php }
                                } ?>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Upload New Image 4<span style="color: #FE5115">*</span></label>
                                <div class="col-sm-8">
