                    ...
                    <div class="card-body p-5">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Current Image1</label>
                                <?php
                                $id = intval($_GET['imgid']);
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {    ?>
                                        ...
                                        <div class="col-sm-8">
                                            <img src="./assets/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" width="300" height="200" style="border:solid 1px #000">
                                        </div>
                                <?php }
                                } ?>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Upload New Image 1<span style="color: #FE5115">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-4">
                                    ...
                                    <button class="btn" style="background-color: #FE5115; color: #FFFFFF; font-weight: bold;" name="update" type="submit">Update</button>
                                </div>
                            </div>
