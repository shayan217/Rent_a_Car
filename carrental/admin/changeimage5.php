                    ...
                    <div class="card-body p-5">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Current Image5</label>
                                <?php
                                $id = intval($_GET['imgid']);
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" style="color: #FFFFFF; font-weight: bold;">Upload New Image 5<span style="color: #FE5115">*</span></label>
                                <div class="col-sm-8">
